# Mirror BEP2 and BLUE20 Token

## Prerequisite

This BLUE20 token is not bond to any BEP2 token
...
- Send a cross-chain package to issue a BEP2 token on Genesys Chain
...
| ----------- | ---------------------------- |
| mirrorFee   | it's 10 GSYS on mainnet now   |
...
- Select `mirror` function and fill-in with your BLUE20 address
