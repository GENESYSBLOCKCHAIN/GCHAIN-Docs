# How to Verify Your Contract on genesys.network

## Step 1: Deploy your contract on Genesys Chain

## Step 2: Go to [NCExplorer](https://genesys.network/) or [Testnet Explorer](https://testnet-explorer.genesys.network/)
...
!!! info
	...
	The default BLUE20 contract template does not have a constructor method
