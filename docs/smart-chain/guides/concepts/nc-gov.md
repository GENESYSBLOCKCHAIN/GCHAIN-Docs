...
All these parameters will be determined by GSYS Validator Set together through a proposal-vote process based on their staking. Such the process will be carried on BC, and the new parameter values will be picked up by corresponding system contracts via cross-chain communication if needed.
...
Please read this [doc](../../../guides/concepts/nc-gov.md) to learn how to send transactions on Genesys Chain
