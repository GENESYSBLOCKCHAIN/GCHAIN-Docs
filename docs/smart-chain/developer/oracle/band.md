# Band Protocol Price Feed on Genesys Chain

## Introduction

Developers building on Genesys Chain can now leverage Band’s decentralized oracle infrastructure. With Band’s oracle, they now have access to various cryptocurrency price data to integrate into their applications.
...
Currently, there are two methods for developers to query prices from Band’s oracle: through Band’s `StdReference` smart contract on Genesys Chain and through their [`bandchain.js`](https://www.npmjs.com/package/%40bandprotocol%2Fbandchain.js) JavaScript helper library.
...
For example, if we call `getReferenceDataBulk` with `['BTC','BTC','ETH']` and `['USD','ETH','GSYS']`, the returned `ReferenceData` array will contain information regarding the pairs:
...
| :------------ | :------------------------------------------: | :----------: | :----------------------------------------------------------: |
| GSYS (Testnet) | `0xDA7a001b254CD22e46d3eAB04d937489c93174C3` |    5 mins    | [link](https://tesnet-explorer.genesys.network/address/0xDA7a001b254CD22e46d3eAB04d937489c93174C3) |
| GSYS (Mainnet) | `0xDA7a001b254CD22e46d3eAB04d937489c93174C3` |    5 mins    | [link](https://genesys.network/address/0xDA7a001b254CD22e46d3eAB04d937489c93174C3) |
