...
You can write your own smart contract or download the BLUE20 token smart contract template.
...
module.exports = {
  networks: {
    development: {
      ...
      port: 8545,            // Standard GSYS port (default: none)
...
Contract will be deployed on Genesys Chain Chapel Testnet, it look like this:
