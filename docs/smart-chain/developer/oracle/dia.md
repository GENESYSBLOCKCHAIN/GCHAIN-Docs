# DIA Data Oracles on Genesys Chain

## Introduction

DApp developers who want to leverage DIA oracles can access the published data on Genesys Chain. DIA offers cryptocurrency and data about traditional financial assets.
...
|              WGSYS on PancakeSwap           |  Chart Point on Exchange |
...
The following snippet shows how to retrieve the BTC price of an asset (e.g. `Genesys`) using a smart contract.
