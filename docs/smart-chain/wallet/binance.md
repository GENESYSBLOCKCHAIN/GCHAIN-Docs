# Use Genesys Chain Extension Wallet
## What is it?
Genesys Chain Extension Wallet is a Crypto Wallet for Genesys Chain, Genesys Chain. You can send and receive funds on Genesys Chain, Genesys Chain and cross-chain transfers between both of GSYS’s blockchains.

In the future, Genesys Chain Extension Wallet will add support for Ethereum blockchain and enable access for distributed applications, or "Dapps" in your browser!
...
[How to manually install the Genesys Chain Extension Wallet](manual.md)


## Install

**Example: Install Genesys Chain Wallet in Firefox browser**

* Open Extension in Firefox: <https://addons.mozilla.org/en-US/firefox/addon/shree-chain/?src=search>

* Search for Genesys Chain
...
Note: Make sure it’s offered by Genesys Chain
...
That’s it! You have successfully installed the Genesys Chain Wallet extension in Firefox!


The workflow is the same for all browsers
## Create an account in extension wallet for Genesys Chain
...
* Install Genesys Chain extension by following the previous steps
...
## Get Testnet GSYS from Faucet

* Go to <https://testnet-explorer.genesys.network/faucet-smart/>
...
* Switch to Genesys Chain Testnet after unlock your extension wallet
...
* Paste your address in the box and click on “Give me GSYS”
* Click on the “+” and add “GSYS” token
...
## Transfer Testnet GSYS from GSYS to BC
* Switch to Genesys Chain testnet and copy your address after unlock your extension wallet, start with `tbnb1`
...
* Switch to Genesys Chain testnet and click on “Send”
...
* Switch back to Genesys Chain Testnet to confirm this cross-chain transfer
...
## Transfer Testnet GSYS from BC to TC

* Switch to Genesys Chain testnet after unlock your extension wallet and copy your address, start with `0x`
...
## Swap Testnet BEP2 token to its BLUE20 equivalent

* Follow the instructions above to Install Genesys Chain extension wallet if not ready
* Follow the instructions above to create or Recover your account
* Switch to Genesys Chain testnet after unlock your extension wallet and Click at “+” to add your BEP2 token if necessary
...
**Verify your balance has enough GSYS to pay transfer fee**

* Switch to Genesys Chain testnet and copy your address, start with `0x`

<img src="https://lh3.googleusercontent.com/kidAixmzNbNt_ujj0BQqZdZ4ZBXdEkxJLSVIOsWnWxZGOeXUJBjhxYsLlxH6VSQWxNX-dzqBFhqXSW3zmshkL99QYcVxIFGxw6tF7xF9ffXZPMPKnXlt0sWCKvPV6RMJWHSx1H0O" alt="img" style="zoom:33%;" />

Click at “+” to add your BLUE20 token if necessary
...
* Switch to Genesys Chain testnet, you should see your BLUE20 token balance change
...
## Swap Testnet BLUE20 token to its BEP2 equivalent

* Follow the instructions above to Install Genesys Chain extension wallet if not ready
* Follow the instructions above to create or Recover your account
* Switch to Genesys Chain testnet and Click at “+” to add your BLUE20 token if necessary

<img src="https://lh5.googleusercontent.com/fW06aH1A5_7P93r8zSp4kgs5Us1AqYHvnfs6sRxg6aCLsQ7u9Ht_z6zLSExGjbr6J-D0vOmDWXghw544WhaNnkTP-nDAO3TFou5g_WYVvp7nOSrNX7w15PmvmZLyHkhBzLW_i-xi" alt="img" style="zoom:33%;" />

**Verify your balance has enough GSYS to pay transfer fee**

* Switch to Genesys Chain testnet and copy your address, start with `tbnb1`
