...
GSYS and coins on Genesys Chain are supported by the Trezor hardware wallet. The following describes how to use Trezor to connect to TC.
...
Genesys Chain is compatible with MetaMask. Users can use MetaMask as a bridge between Trezor and Genesys Chain to make transactions to the Genesys Chain testnet.
