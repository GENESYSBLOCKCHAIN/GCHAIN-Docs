...
If those seeds aren't working, you can find more seeds and persistent peers in HTTP API endpoints: https://dex.genesys.network/api/v1/peers
...
* [Explorer](https://gchainexplorer.genesys.network/)
