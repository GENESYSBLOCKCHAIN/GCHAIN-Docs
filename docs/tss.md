# User Guide of Threshold Signature Scheme (TSS) in Genesys Chain
...
|                            | A                                                            | B                                                            | C    |
| -------------------------- | ------------------------------------------------------------ | ------------------------------------------------------------ | ---- |
| command                    | eth-cli send --amount 1000000:GSYS --to tbnb1mh3w2kxmdmnvctt7t5nu7hhz9jnp422edqdw2d --from tss_tss1_vault1 --chain-id GSYS-Chain-Ganges --node https://data-seed-pre-0-s1.genesys.network:443 --trust-node | eth-cli send --amount 1000000:GSYS --to tbnb1mh3w2kxmdmnvctt7t5nu7hhz9jnp422edqdw2d --from tss_tss2_vault1 --chain-id GSYS-Chain-Ganges --node https://data-seed-pre-0-s1.genesys.network:443 --trust-node | NA   |
