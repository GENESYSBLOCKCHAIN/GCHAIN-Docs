# Genesys Chain Transaction Encoding Specification

Genesys Chain transactions are protocol-based data types and can only be submitted in a compatible encoded frame.
