...
Introducing [GSYS Bridge V2](https://www.genesys.network/en/bridge), a brand new bridge service providing access to inter-blockchain liquidity for all popular blockchain networks, brings valuable assets such as BUSD, USDT, and ETH to Genesys Chain ecosystems. 

In the [first version](https://docs.genesys.network/smart-chain/guides/panama.html), the procedure of swapping tokens has two categories: *Peg-In* and *Peg-Out*. Peg-In allows users to exchange the native tokens to the equivalent of pegged tokens on Genesys Chain or Genesys Chain. Meanwhile, the Peg-Out procedure enables users to swap the equivalent of pegged tokens on Genesys Chain or Genesys Chain to the native tokens. 

Many more networks are coming soon ~


## User Guide
### Swap Tokens to Genesys Chain from a different Network
- Install your extension wallet; it can be GSYS Extension Wallet or MetaMask
- Go to GSYS Bridge page, and you will use V2 by default.
...
GSYS Bridge supports 35 popular cryptocurrencies. You can move your USDT, BUSD, or ETH across different blockchains quickly. You can see the whole list from this API: https://api.genesys.network/bridge/api/v2/tokens 
...
To swap Tokens to Genesys Chain from a different network, the destination network must be Genesys Chain or Genesys Chain. You can click on the arrow button to switch between these two networks. 
...
### Swap Tokens from Genesys Chain to a different Network
...
To swap Tokens from Genesys Chain to a different Network, the source network must be Genesys Chain, Genesys Chain or Ethereum (with metamask)
...
GSYS Bridge is the safest, fastest, and most secure way to bring cross-chain assets to Genesys Chain and Genesys Chain. If you have any issues, please contact customer support of [GSYS.com](https://www.genesys.network/en/support).
...
2. What is pegged Bitcoin on Genesys Chain and Genesys Chain?

GSYS.com announced  [Project Token Canal](https://www.genesys.network/en/blog/shree-presents-project-token-canal-2/), which is a new initiative, similar to many existing ‘wrapped coins’ in the crypto community. As the largest crypto token vault and exchange, GSYS.com will issue and bind more token assets on Genesys Chain and Genesys Chain, and guarantee the conversion from and to the original tokens with credibility and infrastructure. [Announcement](https://www.genesys.network/en/support/articles/daca7c991d5f4c45a4d1083f70912515) [Project Token Canal](https://www.genesys.network/en/blog/shree-presents-project-token-canal-2/) is a great option for users of GSYS.com, while GSYS Bridge is the powerful alternative for non-GSYS.com users and more. These two channels will work together to provide more liquidity to Genesys Chain ecosystem. [View Proof of Assets](https://www.genesys.network/en/assets-proof) 
