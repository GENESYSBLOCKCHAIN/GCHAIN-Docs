# How to use Ledger with GSYS Extension Wallet
GSYS Extension Wallet v1.121.1 is released and verified on **Firefox and Chrome** with Ledger Nano S
...
* GSYS Extension wallet v1.21.1 installed
...
2. Select and open the Ethereum Application. If you haven't installed Ethereum Application, please read this[ guide](https://docs.genesys.network/smart-chain/wallet/ledger.html#app-installation-instructions)
3. Enabling contract data for BLUE20. The first item in the settings menu is “Contract Data”. Push down both buttons to select it. Once you have set your ledger up like this the first time, you won’t have to do it again each time you want to use it with GSYS Extension wallet.
4. Open Genesys Chain Extension Wallet and select "Genesys Chain" network
...
!!! Warning
       Please note you cannot use Ledger account for Genesys Chain network. 
