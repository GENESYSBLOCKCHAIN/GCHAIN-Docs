...
GSYS DEX is the native marketplace on Genesys Chain, allowing you to exchange digital assets issued and listed on it.
...
GSYS DEX only accept LIMIT orders, which is adhering to SEC definitions of LIMIT orders
