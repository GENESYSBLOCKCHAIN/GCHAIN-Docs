...
## How to delegate your GSYS with extension wallet

- [Install Genesys Chain extension wallet](shree.md)
...
## How to redelegate your GSYS with extension wallet

By staking you GSYS, you participate in the selection process of Genesys Chain validators and earn rewards. Staking GSYS is critical for securing the network. Validators can self-bond, meaning they can delegate GSYS to themselves, and they can also receive delegations from any other GSYS holders.
...
## How to undelegate your GSYS with extension wallet
